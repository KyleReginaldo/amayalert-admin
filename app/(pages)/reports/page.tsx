...
export default function ReportsPage() {
  ...
  const uniquePostsReported = new Set(reports.map((r) => r.post)).size;
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-2 w-full sm:w-64 md:w-80 rounded-md border bg-muted/30 px-2 py-1 focus-within:ring-1 focus-within:ring-primary transition-all">
